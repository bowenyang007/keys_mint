...
payload = {
  ...
  function: `0x${process.env.RES_ACCOUNT}::minting::set_treasury`,
  arguments: [new_treasury_address],
  type_arguments: []
};
...
if (result.success) {
  console.log(`Set admin successful, new admin ${new_treasury_address}. Transaction ${result.version}`);
} else {
