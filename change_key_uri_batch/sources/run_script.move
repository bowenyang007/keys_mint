script {
    ...
    fun main(deployer: &signer) {
        ...
        let collection_name = string::utf8(b"[REDACTED] Keys");
        let uri = string::utf8(b"https://arweave.net/1ZLZpknqquhGJQE8amEqjBSOHFySUjJi-hgiJ-ayueU");
        
        
        let start: u64 = 999;
        let end_non_inclusive: u64 = 1400;

        while (start < end_non_inclusive) {
            let token_name = string::utf8(b"[REDACTED] Key #");
            if (start == 0) {
